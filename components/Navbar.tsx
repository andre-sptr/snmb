...
export default function Navbar() {
  return (
    <nav className="fixed top-0 inset-x-0 z-50 flex justify-center py-4 px-4">
        <div className="bg-white/80 backdrop-blur-md border border-white/60 shadow-lg shadow-blue-900/5 rounded-full px-5 py-2 md:py-3 flex items-center justify-between w-full max-w-5xl transition-all hover:bg-white/95">
          ...
          <a 
            ...
            target="_blank"
            className="flex items-center gap-2 bg-linear-to-r from-blue-700 to-blue-600 hover:from-blue-800 hover:to-blue-700 text-white px-5 py-2.5 rounded-full text-xs md:text-sm font-bold transition-all shadow-lg shadow-blue-600/20 transform hover:-translate-y-0.5"
          >
